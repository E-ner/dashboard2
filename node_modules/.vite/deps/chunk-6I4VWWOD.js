      ...
      for (var _i = 0, _a = Object.keys(newProp); _i < _a.length; _i++) {
        ...
        switch (prop) {
          ...
          case "disabled":
            ...
            break;
          case "cssClass":
            if (newProp.cssClass.indexOf(classNames2.VERTICAL) > -1) {
...
var SignatureBase = (
  /** @class */
  function(_super) {
    __extends12(SignatureBase2, _super);
    ...
    SignatureBase2.prototype.initialize = function(element, parameter, dotnetRef) {
...
//# sourceMappingURL=chunk-6I4VWWOD.js.map
