    ...
    Data2.prototype.dataManagerSuccess = function(e, type, offlineArgs, index) {
      ...
      if (type) {
        ...
        this.parent.trigger(dataBinding, e, function(args) {
          ...
          _this.parent.notify(dataReady, { processedData: resultData2 });
...
var SwimlaneSettings = (
  /** @class */
  function(_super) {
    __extends3(SwimlaneSettings2, _super);
...
var CardSettings = (
  /** @class */
  function(_super) {
    __extends4(CardSettings2, _super);
...
var DialogSettings = (
  /** @class */
  function(_super) {
    __extends5(DialogSettings2, _super);
...
var StackedHeaders = (
  /** @class */
  function(_super) {
    __extends7(StackedHeaders2, _super);
...
var SortSettings = (
  /** @class */
  function(_super) {
    __extends8(SortSettings2, _super);
...
var DragAndDrop = (
  ...
  function() {
    ...
    DragAndDrop2.prototype.changeOrder = function(modifieddata) {
      var _this = this;
      var prevele = false;
...
var LayoutRender = (
  /** @class */
  function(_super) {
    __extends9(LayoutRender2, _super);
    ...
    LayoutRender2.prototype.renderSwimlaneRow = function(tBody, row, isCollapsed) {
      ...
      var tr = createElement("tr", {
        ...
        attrs: { "data-key": row.keyField, "aria-expanded": (!isCollapsed).toString() }
      });
...
var KanbanComponent = (
  /** @class */
  function(_super) {
    __extends11(KanbanComponent2, _super);
